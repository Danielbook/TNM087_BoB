...
for k = 1:nopts
    ...
    if ColorType == 'grayscale'
        DImage(round(PtPos(k,2) - Qsize/2):round(PtPos(k,2) + Qsize/2), round(PtPos(k,1) - Qsize/2):round(PtPos(k,1) + Qsize/2),1) = 255;
    else
        DImage(round(PtPos(k,2) - Qsize/2):round(PtPos(k,2) + Qsize/2), round(PtPos(k,1) - Qsize/2):round(PtPos(k,1) + Qsize/2),1) = 255;
        DImage(round(PtPos(k,2) - Qsize/2):round(PtPos(k,2) + Qsize/2), round(PtPos(k,1) - Qsize/2):round(PtPos(k,1) + Qsize/2),2) = 255;
        DImage(round(PtPos(k,2) - Qsize/2):round(PtPos(k,2) + Qsize/2), round(PtPos(k,1) - Qsize/2):round(PtPos(k,1) + Qsize/2),3) = 255;
    end
end
imshow(DImage);
